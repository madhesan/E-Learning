    ...
    <div>
      ...
      <div className="common_style">
        ...
        <div className='shadow2'>
          ...
          <h5>Gradually You Can Check All Of Our Courses</h5>
        
         
            <p>Infographic Learning Curve Innovator.<br/> Vesting

Period Success Interaction Design Bandwidth<br/>

Burn Rate IPhone Incubator Deployment

Creative Responsive</p>
